<main class="bg-black">
    <!--        BANNER-->
    <div id="banner"
         class="font-bold bg-white h-2/4 relative pt-16 pb-32 w-full flex justify-center"
         style="min-height: 60vh;">
        <div class="mx-auto w-full flex justify-center flex-wrap">
            <div class="w-full px-4 mx-auto text-center">
                <div class="w-full flex flex-col justify-center">
                    <img data-aos="fade-in" data-aos-duration="1500" id="logos" class="mx-auto w-2/5"
                         src="assets/img/ADWEB.gif" alt="">
                    <p id="intro" data-aos="fade-up" data-aos-delay="400"
                       class="mx-auto mt-12 w-6/12 title-font mb-4 text-2xl tracking-tight sm:text-sm sm:leading-none md:text-lg text-gray-300 ">
                        "Bonjour et bienvenue sur mon portfolio, vous y retrouverez une présentation me concernant, mon
                        parcours de compétence et bien d'autres informations." <br>
                        <br>
                    </p>
                    <span data-aos="fade-up" data-aos-delay="1400"
                          class="font-bold italic text-yellow-300">Adam Fraga</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!--    SECTION TEXTE INTRO-->
    <section class="bg-black relative pt-5 my-32 ">
        <div
        ...
        <div class="container my-32 mx-auto px-4">
            <div class="items-center flex flex-wrap">
                ...
                <div data-aos="zoom-in-up" data-aos-delay="500" class=" w-full md:w-6/12 ml-auto mr-auto px-4">
                    <div class="md:pr-12">
                        <h2 class="title-font mb-4 text-4xl font-extrabold leading-10 tracking-tight sm:text-5xl sm:leading-none md:text-4xl text-gray-200 ">
                            Hello world !</h2>
                        <p data-aos="fade-in" data-aos-delay="800"
                           class="mt-4 text-lg leading-relaxed text-gray-200 text-justify italic">
                            Je m'appelle <span class="font-bold text-yellow-300">Adam Fraga</span>, je suis passionné de
                            technologie et de nature et vous vous trouvez ici sur la page d'accueil de mon portfolio !
                        </p> <br>
                        <button id="btn-infos-moi"
                                class="text-yellow-300 bg-transparent border border-solid border-yellow-300 hover:bg-yellow-300 hover:text-white active:bg-yellow-400 font-bold uppercase px-8 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button">
    ...
    <!--    SECTION RESUME-->
    <section class="pb-20 bg-black my-32">
            ...
            <div class=" p-16 flex flex-wrap items-center">
                ...
                <div class="bg-black w-full md:w-7/12 px-4 mr-auto ml-auto">
                    <div class=" relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg">
                        <img class="opacity-70" data-aos="fade-up" data-aos-anchor-placement="top-center" alt="..."
    ...
    <!--Section Timeline Competences-->
    <section class="my-32">
        <div class="container bg-white mx-auto w-full h-full">
            <div class="relative wrap overflow-hidden p-10 h-full">
                <h2 class="my-12 mb-40 text-center title-font mb-4 text-3xl font-extrabold leading-10 tracking-tight sm:text-2xl sm:leading-none md:text-3xl text-gray-800">
                    PARCOURT DE COMPÉTENCES</h2>
                ...
                <div class="mb-8 flex justify-between items-center w-full right-timeline">
                    ...
                    <div data-aos="fade-in" data-aos-delay="100"
                        ...
                        <h4 class="mx-auto font-semibold text-lg text-white">1</h4>
                    </div>
